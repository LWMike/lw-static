			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - LW Static</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - LW Static</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://https://lw-static-xq8p5.kinsta.page/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
